...
async def generate_gemini_insights(selected_text: str, relevant_snippets: List[dict]) -> dict:
    ...
    try:
        ...
        enhanced_prompt = f"""
        You are a world-class research analyst and document intelligence expert. You have been given a text selection from a current document and related excerpts from a user's personal document library. Your task is to provide EXTRAORDINARY, DEEP, and ACTIONABLE insights that go far beyond surface-level analysis.
