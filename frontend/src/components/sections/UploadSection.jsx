  ...
  const personas = [
    {
      value: "student",
      label: "Student",
      description: "Academic analysis and learning focus",
    },
    {
      value: "researcher",
      label: "Researcher",
      description: "Scientific and research methodology",
    },
    {
    ...
    },
    {
      value: "executive",
      label: "Executive",
      description: "Strategic overview and decision making",
    },
  ];
    ...
    <section id="upload" className="py-24 bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Upload your PDF documents and select your professional role for
            comprehensive AI-powered analysis and comparison.
          </p>
        </div>
                ...
                <div>
                  <p className="text-gray-300">
                    {uploadMode === "single"
                      ...
                      : "Drag and drop your PDF documents here (max 5)"}
                  </p>
                  <label className="cursor-pointer text-red-600 hover:text-red-500 font-medium">
                    or browse files
                    <input
            ...
            {((uploadMode === "single" && singleFile) ||
              ...
              <div className="mb-4 p-3 bg-gray-700 rounded-lg border border-gray-600">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-2xl">{isUploaded ? "✅" : "⏳"}</div>
                </div>
              </div>
            )}
              ...
              {files.length > 0 && (
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-h-[500px] bg-gray-900 rounded">
                    {useAdobeViewer ? (
                      <AdobePdfViewer
                        pdfFile={files[currentFileIndex]}
